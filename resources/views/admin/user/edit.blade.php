        ...
        <h1 class="page-header">
            ...
            <div class="pull-right">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('admin.user.show', $user->id) }}">{{ $user->present()->nameOrEmail }}</a></li>
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="details">
        <div class="row">
            <div class="col-lg-8 col-md-7">
                {!! Form::open(['route' => ['admin.user.update.details', $user->id], 'method' => 'PUT', 'id' => 'details-form']) !!}
                    @include('admin.user.partials.details', ['profile' => false])
                {!! Form::close() !!}
            </div>
            <div class="col-lg-4 col-md-5">
                {!! Form::open(['route' => ['admin.user.update.avatar', $user->id], 'files' => true, 'id' => 'avatar-form']) !!}
                    @include('admin.user.partials.avatar', ['updateUrl' => route('admin.user.update.avatar.external', $user->id)])
                {!! Form::close() !!}
            </div>
        </div>
    </div>
    <div role="tabpanel" class="tab-pane" id="social-networks">
        <div class="row">
            <div class="col-md-12">
                {!! Form::open(['route' => ['admin.user.update.socials', $user->id]]) !!}
    ...
    <div role="tabpanel" class="tab-pane" id="auth">
        <div class="row">
            <div class="col-md-8">
                {!! Form::open(['route' => ['admin.user.update.login-details', $user->id], 'method' => 'PUT', 'id' => 'login-details-form']) !!}
