...
{!! Form::open(['route' => 'admin.permission.save']) !!}
        ...
        @if (count($permissions))
            @foreach ($permissions as $permission)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.permission.edit', $permission->id) }}" class="btn btn-primary btn-circle"
                           title="@lang('app.edit_permission')" data-toggle="tooltip" data-placement="top">
                            <i class="glyphicon glyphicon-edit"></i>
                        </a>
                        @if ($permission->removable)
                            <a href="{{ route('admin.permission.destroy', $permission->id) }}" class="btn btn-danger btn-circle"
