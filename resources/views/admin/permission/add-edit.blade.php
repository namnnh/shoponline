        ...
        <h1 class="page-header">
            ...
            <div class="pull-right">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('admin.permission.index') }}">@lang('app.permissions')</a></li>
...
@if ($edit)
    {!! Form::open(['route' => ['admin.permission.update', $permission->id], 'method' => 'PUT', 'id' => 'permission-form']) !!}
@else
    {!! Form::open(['route' => 'admin.permission.store', 'id' => 'permission-form']) !!}
@endif
...
@section('scripts')
     @if ($edit)
        {!! JsValidator::formRequest('App\Http\Requests\Admin\Permission\UpdatePermissionRequest', '#permission-form') !!}
    @else
        {!! JsValidator::formRequest('App\Http\Requests\Admin\Permission\CreatePermissionRequest', '#permission-form') !!}
    @endif 
@stop