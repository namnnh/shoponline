...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="auth">
        <div class="row">
            ...
            <div class="col-md-6">
                @include('admin.settings.partials.throttling')
            </div>
        </div>
    </div>
    <div role="tabpanel" class="tab-pane" id="registration">
        <div class="row">
            <div class="col-md-6">
                @include('admin.settings.partials.registration')
            </div>
            <div class="col-md-6">
                @include('admin.settings.partials.recaptcha')
            </div>
        </div>
    </div>
</div>
...
@section('scripts')
    {!! HTML::script('assets/admin/plugins/bootstrap-switch/bootstrap-switch.min.js') !!}
    <script>
...
@section('styles')
    {!! HTML::style('assets/admin/plugins/bootstrap-switch/bootstrap-switch.css') !!}
@stop