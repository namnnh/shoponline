    ...
    <div class="panel-body">
        ...
        @else
            @if (settings('registration.captcha.enabled'))
                {!! Form::open(['route' => 'admin.settings.registration.captcha.disable', 'id' => 'captcha-settings-form']) !!}
                ...
                {!! Form::close() !!}
            @else
                {!! Form::open(['route' => 'admin.settings.registration.captcha.enable', 'id' => 'captcha-settings-form']) !!}
