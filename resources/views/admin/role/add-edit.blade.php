        ...
        <h1 class="page-header">
            ...
            <div class="pull-right">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('admin.role.index') }}">@lang('app.roles')</a></li>
...
@if ($edit)
    {!! Form::open(['route' => ['admin.role.update', $role->id], 'method' => 'PUT', 'id' => 'role-form']) !!}
@else
    {!! Form::open(['route' => 'admin.role.store', 'id' => 'role-form']) !!}
@endif
...
@section('scripts')
    ...
    @else
        {!! JsValidator::formRequest('App\Http\Requests\Admin\Role\CreateRoleRequest', '#role-form') !!}
    @endif  
@stop