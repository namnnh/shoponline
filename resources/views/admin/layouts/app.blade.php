...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ url('assets/admin/img/icons/apple-touch-icon-144x144.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ url('assets/admin/img/icons/apple-touch-icon-152x152.png') }}" />
    <link rel="icon" type="image/png" href="{{ url('assets/admin/img/icons/favicon-32x32.png') }}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{ url('assets/admin/img/icons/favicon-16x16.png') }}" sizes="16x16" />
    <meta name="application-name" content="{{ settings('app_name') }}"/>
    <meta name="msapplication-TileColor" content="#FFFFFF" />
    <meta name="msapplication-TileImage" content="{{ url('assets/admin/img/icons/mstile-144x144.png') }}" />
    ...
    {!! HTML::style('assets/admin/css/sweetalert.css') !!}
...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('dashboard') }}" style="padding: 7px 0 0 0;">
                    <img src="{{ url('assets/admin/img/vanguard-logo.png') }}" height="40" alt="{{ settings('app_name') }}">
                </a>
            </div>
    ...
    {!! HTML::script('assets/admin/js/sweetalert.min.js') !!}
    {!! HTML::script('assets/admin/js/delete.handler.js') !!}
    {!! HTML::script('assets/admin/plugins/js-cookie/js.cookie.js') !!}
