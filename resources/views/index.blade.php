...
@section('content')
                            ...
                            <div class="container">
                                <div class="col-lg-5 col-md-4 col-sm-6 col-xs-8   pull-left sliderText white hidden-xs">
                                    <div class="inner">
                                        ...
                                        <p class="hidden-xs">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-7   pull-left sliderText blankstyle color-white">
                                    <div class="inner">
                                        ...
                                        <p class="bot tomAnima animated opacity0 hidden-xs"> Fully responsive bootstrap Ecommerce Template. Available in 10+ color schemes and easy
                                            to set. </p>
                                    </div>
                                </div>
                            </div>
    ...
    @include('_particles.component._newArrivals')
    @include('_particles.component._parallax')
    @include('_particles.component._featured')
    @include('_particles.component._brand')
    @include('_particles.component._parallax')
